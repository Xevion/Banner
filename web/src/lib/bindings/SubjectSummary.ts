...
export type SubjectSummary = { subject: string, subjectDescription: string | null, trackedCourseCount: number, scheduleState: ScheduleState, currentIntervalSecs: number, timeMultiplier: number, 
/**
